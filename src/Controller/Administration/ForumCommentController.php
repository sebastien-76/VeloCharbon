...
final class ForumCommentController extends AbstractController
{
    ...
    {
        return $this->render('forum_comment/index.html.twig', [
            'forum_comments' => $forumCommentRepository->findAll(),
        ]);
    }

    #[Route('/new', name: 'app_forum_comment_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('forum_comment/new.html.twig', [
            'forum_comment' => $forumComment,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_forum_comment_show', methods: ['GET'])]
    public function show(ForumComment $forumComment): Response
    {
        return $this->render('forum_comment/show.html.twig', [
            'forum_comment' => $forumComment,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_forum_comment_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_forum_comment_delete', methods: ['POST'])]
