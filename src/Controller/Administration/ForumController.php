...
final class ForumController extends AbstractController
{
    ...
    #[Route('/{id}', name: 'app_forum_show', methods: ['GET'], requirements:['id' => Requirement::DIGITS])]
    ...
    #[Route('/{id}/edit', name: 'app_forum_edit', methods: ['GET', 'POST'], requirements:['id' => Requirement::DIGITS])]
    ...
    #[Route('/{id}', name: 'app_forum_delete', methods: ['POST'], requirements:['id' => Requirement::DIGITS])]
